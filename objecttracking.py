...
cv2.createTrackbar("HUE Min","HSV",106,179,empty)
cv2.createTrackbar("HUE Max","HSV",179,179,empty)
cv2.createTrackbar("SAT Min","HSV",166,255,empty)
cv2.createTrackbar("SAT Max","HSV",255,255,empty)
cv2.createTrackbar("VALUE Min","HSV",32,255,empty)
cv2.createTrackbar("VALUE Max","HSV",228,255,empty)

cv2.namedWindow("Parameters")
cv2.resizeWindow("Parameters",640,240)
cv2.createTrackbar("Threshold1","Parameters",48,255,empty)
cv2.createTrackbar("Threshold2","Parameters",111,255,empty)
